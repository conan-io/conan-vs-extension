...
namespace Conan.VisualStudio.Tests
{
    internal static class ResourceUtils
    {
        ...
        public static string ConanfileTxt => GetResourcePath("conanfile.txt");
        public static string ConanfilePy => GetResourcePath("conanfile.py");
        public static string TasksVsJson => GetResourcePath("tasks.vs.json");
    }
}
